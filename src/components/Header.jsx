...
const Header = () => {
    ...
    return (
        <header className="sticky top-0 z-10 bg-white">
            <div className="relative bg-white z-20 flex items-center justify-between p-4 w-full mx-auto max-w-[1000px]">
            ...
            {/* Mobile Nav */}
            <nav
                className={`z-10 absolute w-full bg-white max-[900px]:flex flex-col items-center py-4 border-t border-gray-bg transition-transform ${
